 ...
 *
 */
public class AlphaNumericComparator implements Comparator<S3Object> {
     ...
     */
    @Override
    public int compare(S3Object s1, S3Object s2) {
        String o1 = s1.key();
        String o2 = s2.key();
        if ((o1 == null || o1.isEmpty()) && (o2 != null && !o2.trim().isEmpty())) {
            return -1;
        }
        if ((o2 == null || o2.isEmpty()) && (o1 != null && !o1.trim().isEmpty())) {
            return 1;
        }
        if ((o1 == null || o1.trim().isEmpty()) && (o2 == null || o2.trim().isEmpty())) {
            return 0;
        }
        ...
        int s1Index = 0;
        int s2Index = 0;
        while (s1Index < o1.length() && s2Index < o2.length()) {
            int result = 0;
            String s1Slice = this.slice(o1, s1Index);
            String s2Slice = this.slice(o2, s2Index);
